...
|------------|------------|------------------------------------------------------------------|-----------------|
| 2026-08-10 | 2027-11-06 | E0A3D0CD7FDD5539438A44E0513450C02CC8550B46F23C6A4FE2EFD194E9199F | 92A72A9CD8462B3CBE2FB9026563E8A343C9C8F6 |
...
To validate the signature of a file run the following command and compare the `SignerCertificate` with the SHA1
...
To validate the signature of a nupkg run the following command on Windows or Linux with a .NET SDK installed to validate the signature of a file. Compare the `SHA256 hash` under
...
- [Signed packages](https://learn.microsoft.com/en-us/nuget/reference/signed-packages-reference)
